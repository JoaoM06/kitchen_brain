...
const styles = StyleSheet.create({
  ...
  videoBtn: {
    ...
    backgroundColor: colors.primary, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999,
  },
  videoBtnText: { color: "#fff", fontWeight: "700" },
  backBtn: {
    position: "absolute", top: 40, left: 20,
    backgroundColor: "rgba(255,255,255,0.9)", paddingHorizontal: 14, paddingVertical: 6, borderRadius: 999,
  },
