...
export default function ConfigsScreen({ navigation }) {
  ...
  const settings = [
    { id: '1', title: 'Ajuda', icon: <Ionicons name="help-circle-outline" size={24} color="black" />, screen: 'Help' },
    { id: '2', title: 'Sobre', icon: <Entypo name="info-with-circle" size={24} color="black" />, screen: 'About' },
    { id: '3', title: 'Permissões', icon: <MaterialIcons name="assignment" size={24} color="black" />, screen: 'Permissions' },
    { id: '4', title: 'Acessibilidade', icon: <FontAwesome5 name="universal-access" size={24} color="black" />, screen: 'Accessibility' },
    { id: '5', title: 'Logout', icon: <Ionicons name="log-out-outline" size={24} color="#dc2626" />, action: handleLogout, isDestructive: true },
  ];
